...
class Visage: NSObject, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    // try
    fileprivate var photoDataOutput : AVCapturePhotoOutput?
    //    fileprivate var videoDataOutputQueue : DispatchQueue?
    // try
